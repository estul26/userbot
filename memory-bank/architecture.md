...
- The default order candidate regex is `\b[A-Za-z0-9][A-Za-z0-9_-]{5,}\b`; matched candidates must contain at least one digit and obvious date tokens are ignored.
